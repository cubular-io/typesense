...
func NewUpdateDocumentsRequestWithBody(server string, collectionName string, params *UpdateDocumentsParams, contentType string, body io.Reader) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.UpdateDocumentsParameters != nil {

			if queryFrag, err := runtime.StyleParamWithLocation("form", true, "updateDocumentsParameters", runtime.ParamLocationQuery, *params.UpdateDocumentsParameters); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
