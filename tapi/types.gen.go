// Package tapi provides primitives to interact with the openapi HTTP API.
//
...
const (
	CoerceOrDrop   ImportDocumentsParamsImportDocumentsParametersDirtyValues = "coerce_or_drop"
	CoerceOrReject ImportDocumentsParamsImportDocumentsParametersDirtyValues = "coerce_or_reject"
	Drop           ImportDocumentsParamsImportDocumentsParametersDirtyValues = "drop"
	Reject         ImportDocumentsParamsImportDocumentsParametersDirtyValues = "reject"
)
...
type SearchResultHit struct {
	...
	Document *map[string]map[string]interface{} `json:"document,omitempty"`
...
type DeleteDocumentsParams struct {
	DeleteDocumentsParameters *struct {
		// BatchSize Batch size parameter controls the number of documents that should be deleted at a time. A larger value will speed up deletions, but will impact performance of other operations running on the server.
...
type ExportDocumentsParams struct {
	...
	} `form:"exportDocumentsParameters,omitempty" json:"exportDocumentsParameters,omitempty"`
}
...
type ImportDocumentsParams struct {
	...
	} `form:"importDocumentsParameters,omitempty" json:"importDocumentsParameters,omitempty"`
}
